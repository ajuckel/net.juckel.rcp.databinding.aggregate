...
public interface ExamResult extends EObject, Comparable<ExamResult> {
    ...
    /**
     * Returns the value of the '<em><b>Student</b></em>' reference. It is
     * bidirectional and its opposite is '
     * {@link net.juckel.rcp.databinding.aggregate.tests.model.Student#getTestResults
     * <em>Test Results</em>}'. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Student</em>' reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * Sets the value of the '
     * {@link net.juckel.rcp.databinding.aggregate.tests.model.ExamResult#getStudent
     * <em>Student</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
     *            the new value of the '<em>Student</em>' reference.
     * @see #getStudent()
     * @generated
     */
