 ...
 * @generated
 */
public class ClassroomFactoryImpl extends EFactoryImpl implements ClassroomFactory {
	/**
	...
	public static ClassroomFactory init() {
		try {
			ClassroomFactory theClassroomFactory = (ClassroomFactory)EPackage.Registry.INSTANCE.getEFactory("http://net.juckel/rcp/databinding/tests/"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ClassroomPackage.STUDENT: return createStudent();
			case ClassroomPackage.EXAM_RESULT: return createExamResult();
			default:
