...
public interface ClassroomPackage extends EPackage {
	 ...
	 * @generated
	 */
	ClassroomPackage eINSTANCE = net.juckel.rcp.databinding.aggregate.tests.model.impl.ClassroomPackageImpl.init();

	/**
	 * The meta object id for the '{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.StudentImpl <em>Student</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The meta object id for the '{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.ExamResultImpl <em>Exam Result</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link net.juckel.rcp.databinding.aggregate.tests.model.Student <em>Student</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link net.juckel.rcp.databinding.aggregate.tests.model.Student#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference list '{@link net.juckel.rcp.databinding.aggregate.tests.model.Student#getTestResults <em>Test Results</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link net.juckel.rcp.databinding.aggregate.tests.model.ExamResult <em>Exam Result</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link net.juckel.rcp.databinding.aggregate.tests.model.ExamResult#getScore <em>Score</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link net.juckel.rcp.databinding.aggregate.tests.model.ExamResult#getStudent <em>Student</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link net.juckel.rcp.databinding.aggregate.tests.model.ExamResult#getWeight <em>Weight</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.StudentImpl <em>Student</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see net.juckel.rcp.databinding.aggregate.tests.model.impl.StudentImpl
		 * @see net.juckel.rcp.databinding.aggregate.tests.model.impl.ClassroomPackageImpl#getStudent()
		...
		/**
		 * The meta object literal for the '<em><b>Test Results</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.ExamResultImpl <em>Exam Result</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see net.juckel.rcp.databinding.aggregate.tests.model.impl.ExamResultImpl
		 * @see net.juckel.rcp.databinding.aggregate.tests.model.impl.ClassroomPackageImpl#getExamResult()
