 ...
 * <ul>
 * <li>
 * {@link net.juckel.rcp.databinding.aggregate.tests.model.impl.StudentImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link net.juckel.rcp.databinding.aggregate.tests.model.impl.StudentImpl#getTestResults
 * <em>Test Results</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class StudentImpl extends EObjectImpl implements Student {
    ...
    /**
     * The cached value of the '{@link #getTestResults() <em>Test Results</em>}'
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ClassroomPackage.STUDENT__NAME, oldName, name));
    }
    ...
    public EList<ExamResult> getTestResults() {
        if (testResults == null) {
            testResults = new EObjectWithInverseResolvingEList<ExamResult>(
                    ExamResult.class, this,
                    ClassroomPackage.STUDENT__TEST_RESULTS,
                    ClassroomPackage.EXAM_RESULT__STUDENT);
        }
        return testResults;
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd,
        ...
        case ClassroomPackage.STUDENT__TEST_RESULTS:
            return ((InternalEList<InternalEObject>) (InternalEList<?>) getTestResults())
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd,
        ...
        switch (featureID) {
        case ClassroomPackage.STUDENT__TEST_RESULTS:
            return ((InternalEList<?>) getTestResults()).basicRemove(otherEnd,
                    msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case ClassroomPackage.STUDENT__TEST_RESULTS:
            ...
            getTestResults()
                    .addAll((Collection<? extends ExamResult>) newValue);
            return;
        }
