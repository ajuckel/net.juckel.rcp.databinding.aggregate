...
public interface ClassroomFactory extends EFactory {
     ...
     * @generated
     */
    ClassroomFactory eINSTANCE = net.juckel.rcp.databinding.aggregate.tests.model.impl.ClassroomFactoryImpl
            .init();
    ...
    /**
     * Returns a new object of class '<em>Exam Result</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
