 ...
 * <ul>
 *   <li>{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.ExamResultImpl#getScore <em>Score</em>}</li>
 *   <li>{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.ExamResultImpl#getStudent <em>Student</em>}</li>
 *   <li>{@link net.juckel.rcp.databinding.aggregate.tests.model.impl.ExamResultImpl#getWeight <em>Weight</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExamResultImpl extends EObjectImpl implements ExamResult {
	...
	public void setScore(double newScore) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassroomPackage.EXAM_RESULT__SCORE, oldScore, score));
	}
	...
	public Student getStudent() {
		if (student != null && student.eIsProxy()) {
			...
			if (student != oldStudent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassroomPackage.EXAM_RESULT__STUDENT, oldStudent, student));
			}
		}
		return student;
	}
	...
	public NotificationChain basicSetStudent(Student newStudent, NotificationChain msgs) {
		...
		student = newStudent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassroomPackage.EXAM_RESULT__STUDENT, oldStudent, newStudent);
	...
	public void setStudent(Student newStudent) {
		if (newStudent != student) {
			...
			if (student != null)
				msgs = ((InternalEObject)student).eInverseRemove(this, ClassroomPackage.STUDENT__TEST_RESULTS, Student.class, msgs);
			if (newStudent != null)
				msgs = ((InternalEObject)newStudent).eInverseAdd(this, ClassroomPackage.STUDENT__TEST_RESULTS, Student.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassroomPackage.EXAM_RESULT__STUDENT, newStudent, newStudent));
	}
	...
	public void setWeight(double newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassroomPackage.EXAM_RESULT__WEIGHT, oldWeight, weight));
	}
